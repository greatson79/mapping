...
```
- Base: hsl(210 100% 50%) - #0080FF (Main brand color)
...
```
- Cyan Accent: hsl(190 80% 50%) - #19C3E6 (Events, highlights)
- Indigo Accent: hsl(240 60% 60%) - #818CF8 (Info, links)
```

**Neutral (Cool Gray):**

```
- 50: hsl(210 20% 98%) - Background
- 200: hsl(210 12% 88%) - Border
- 500: hsl(210 8% 50%) - Muted text
- 700: hsl(210 10% 30%) - Body text
- 900: hsl(210 15% 15%) - Heading
```
...
- Use cool gray neutrals for text and borders
...
```
- sm: 0 1px 2px 0 rgba(0, 128, 255, 0.05)
- md: 0 4px 6px -1px rgba(0, 128, 255, 0.1),
      0 2px 4px -1px rgba(0, 128, 255, 0.06)
- lg: 0 10px 15px -3px rgba(0, 128, 255, 0.1),
      0 4px 6px -2px rgba(0, 128, 255, 0.05)
- xl: 0 20px 25px -5px rgba(0, 128, 255, 0.1),
      0 10px 10px -5px rgba(0, 128, 255, 0.04)
```
...
- Use blue-tinted shadows (matching brand)
...
--primary: hsl(210 90% 60%) (lower saturation)
```
...
- [Dropbox](https://dropbox.com) - Blue branding
